## CariPrompt 2.2 — un panneau qui va à l'essentiel
...
| Système | Fichier |
|---|---|
| Mac Apple Silicon (M1 et suivants) | `CariPrompt-2.2.0-macOS-AppleSilicon.dmg` |
| Mac, sans image disque | `CariPrompt-2.2.0-macOS-AppleSilicon.zip` |
| Windows, avec installation | `CariPrompt-2.2.0-Windows-Setup.exe` |
| Windows, sans installation | `CariPrompt-2.2.0-Windows-Portable.exe` |
| Linux, toutes distributions | `CariPrompt-2.2.0-Linux-x86_64.AppImage` |
| Debian / Ubuntu | `CariPrompt-2.2.0-Linux-amd64.deb` |
