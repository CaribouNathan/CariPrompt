...
const en = {
  ...
  orderNote: 'Drag a block by its handle to reorder the panel. The order returns to default on restart — save it in a preset to keep it.',
  undo: 'Undo',
...
const fr: Record<StringKey, string> = {
  ...
  orderNote: "Glissez un bloc par sa poignée pour réordonner le panneau. L'ordre revient par défaut au redémarrage — enregistrez-le dans un préréglage pour le conserver.",
  undo: 'Annuler',
